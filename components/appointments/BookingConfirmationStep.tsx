  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <h2 className="text-2xl font-semibold">Подтвердите ваш приём</h2>
      </div>

      <Card className="max-w-2xl">
        <CardHeader>
          <CardTitle>Итоговой приём</CardTitle>
        </CardHeader>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4 pt-4 border-t">
            <div>
              <p className="text-sm text-muted-foreground">Тип приема</p>
            ...
            <div>
              ...
              <p className="font-medium">Teethify HQ</p>
            </div>
            <div>
      ...
      <div className="flex gap-4 mt-6">
        ...
        <Button onClick={onConfirm} className="bg-primary" disabled={isBooking}>
          {isBooking ? "Назначаем..." : "Подтвердить бронирование"}
        </Button>
      </div>
    </div>
  );
